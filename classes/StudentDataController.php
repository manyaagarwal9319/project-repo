<?php 
    ...
    class StudentDataController{
        ...
        public function addStudentData(){
                ...
                $city = $_POST['city'];
                $state = $_POST['state'];
                $sql = "INSERT INTO `student_data`(`student_name`,`student_email`,`student_mobile`,`student_pin`,`student_city`,`student_state`)VALUE('{$name}','{$email}','{$mobile}','{$pin}','{$city}','{$state}')";
        ...
        // echo $adhar_card_back;
        // echo $adhar_card_front;
        // echo $pancard;
        ...
        public function fetchStudentData(){
                $sql = "SELECT student_data.student_id,student_data.student_name,student_data.student_email,student_data.student_mobile,student_data.student_pin,student_data.student_city,student_data.student_state,student_marks.grade,student_marks.student_total_marks
                FROM student_data
        ...
        public function updateData(){
            ...
            // updating data with
            $sql = "UPDATE  `student_data` SET `student_name`='{$Name}',`student_email`='{$email}',`student_mobile`='{$mobile}',`student_pin`='{$pin}',`student_city`='{$city}',`student_state`='{$state}' WHERE `student_id`='{$st_id}'";
            $this->conn->Execute($sql);
