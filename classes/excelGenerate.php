...
class ExcelFileDownload{
    ...
    function downloadExcelFile(){
        ...
        $objPHP->getActiveSheet()->getStyle('A1:L1')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setARGB('ffccccff');
...
$objPHP->getActiveSheet()->setCellValue('L' . $rowcount, (isset($rows['student_total_marks'])?$rows['student_total_marks']:"-"));
            ...
            $objPHP->getActiveSheet()->getStyle('G' . $rowcount)->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setARGB('ffffeef8');
            ...
            $objPHP->getActiveSheet()->getStyle('I' . $rowcount)->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setARGB('ffffeef8');
            ...
            $objPHP->getActiveSheet()->getStyle('K' . $rowcount)->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setARGB('ffffeef8');
