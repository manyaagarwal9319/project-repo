...
$(document).ready(function (e) {
  $("input[type = file][name = adhar_card_front]").change(function () {
    fileSize = this.files[0].size / 2048;
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response) {
            ...
            show_message("success", "SUBMITTED SUCCESSFULLY");
          } else {
  ...
  if(pincode===''){ 
    ...
    $.ajax({ 
        ...
        success:function(data){ 
          ...
          console.log(getData); 
          if(getData.state=='West Bangal' || getData.state=='America'){ 
    ...
    success: function (data1) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        tr += `<tr>
                ...
                <td align="center">${data[i].student_mobile}</td>
                <td align="center">${data[i].student_pin}</td>
                <td align="center">${data[i].student_city}</td>
                <td align="center">${data[i].student_state}</td>
                <td align="right">${
                ...
                <td align="center"><button class="addMarks-btn"  onclick="AddMarks(${
                  data[i].student_id
                })
                "><i class="fa fa-mortar-board fa-xl"></i></button></td>
                <td align="center"><button class="edit-btn"  onclick="edidtRecord(${
                  data[i].student_id
                })
                "><i class="fa fa-edit fa-xl"></i></button></td>
                <td align="center"><button class="delete-btn" onclick="deletetRecord(${
                  data[i].student_id
                })
                "><i class="fa fa-trash fa-xl"></i></button></td>
            </tr>`;
      }
    ...
    success: function (data) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        if (data[i].adhar_front !== null) {
          tr += `<td align="center"><a href='${data[i].adhar_front}' download><i class="fa fa-download fa-xl"></i></a></td>`;
          tr+=`<td align="center"><button class="edit-btn"  onclick="AadharFrontView(${
          data[i].student_id})"><i class="fa fa-eye fa-xl"></i></button></td>`
        } else {
        ...
        if (data[i].adhar_back !== null) {
          tr += `<td align="center"><a href='${data[i].adhar_back}' download><i class="fa fa-download fa-xl"></i></a></td>`;
        ...
        if (data[i].pancard !== null) {
          ...
          tr += `<td align="center"><a href='${data[i].pancard}' download><i class="fa fa-download fa-xl"></i></a></td>`;
  ...
  if (confirm("Are You Sure, You Want To Update This Record")){
        ...
        $.ajax({
            ...
            for (var i in data) {
                ...
                document.getElementById("edit-pin").value = data[i].student_pin;
                document.getElementById("edit-city").value = data[i].student_city;
                document.getElementById("edit-state").value = data[i].student_state;
...
function modify_data() {
  if (confirm("Click OK, If you double checked your data")){
...
//     formData.append("pancard", imgPancard_Base64);
  ...
  if (name === "" || email === "" || mobile == "" || pin == "" || city == "" || state == "") {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        show_message("success", "EDIT SUCCESSFULLY");
...
function deletetRecord(id) {
  if (confirm("Are You Sure, You Want To Delete This Record")) {
    ...
    $.ajax({
      ...
      success: function (respose) {
        show_message("succes", "DELETED SUCCESSFULLY");
        loadTable();
      },
    }).catch((error) => {
      show_message("error", "can't fetch data");
...
function add_Marks() {
  if (confirm("Are You Sure About The Marks You Entered")){
